  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-slate-200/50 dark:border-slate-700/50 p-6 shadow-sm">
        <h4 className="text-md font-bold text-slate-800 dark:text-white mb-4">Pilih & Edit Akun</h4>
        
        <form onSubmit={handleUpdateAccount} className="space-y-4">
          {/* DROPDOWN PEMILIHAN USER */}
          <div>
            <label className="text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1 block">Pilih Akun yang Ingin Diedit</label>
            <select
          ...
          <div>
            <label className="text-xs font-semibold text-slate-600 dark:text-slate-400 mb-1 block">Username Baru</label>
            <input
              type="text"
